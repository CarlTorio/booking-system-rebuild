...
const DateTimeSelection = ({ bookingData, setBookingData }: DateTimeSelectionProps) => {
  ...
  const fetchBookedTimes = async () => {
    ...
    try {
      ...
      const bookedForDate = await appointmentStore.getAppointmentsByBarber(
      ...
      setIsFullDayUnavailable(unavailableSlots.isFullDay);
      setBookedTimes(bookedForDate);
      setUnavailableTimes(unavailableSlots.slots);
    } catch (error) {
