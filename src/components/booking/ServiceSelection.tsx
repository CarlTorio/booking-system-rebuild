...
const jakeServices = [
  ...
  { id: 'j2', name: 'Hair Color', price: 2000, duration: 60, description: 'Professional hair coloring', isStartingPrice: true },
  { id: 'j4', name: 'Hair Mask or Treatment', price: 2000, duration: 45, description: 'Nourishing hair treatment', isStartingPrice: true },
  { id: 'j10', name: 'One Step Rebond with Hair Color and Hair Mask', price: 3000, duration: 120, description: 'Quick rebonding with color and treatment', isStartingPrice: true },
  { id: 'j5', name: 'Highlights and Tone with Hair Mask Treatment', price: 3500, duration: 180, description: 'Complete highlighting service with treatment', isStartingPrice: true },
  { id: 'j7', name: 'Keratin & Brazilian with Hair Color and Hair Mask', price: 3500, duration: 60, description: 'Keratin or Brazilian treatment with color', isStartingPrice: true },
  ...
  { id: 'j6', name: 'Balayage & Tone with Hair Mask Treatment', price: 4000, duration: 180, description: 'Balayage coloring with treatment', isStartingPrice: true },
